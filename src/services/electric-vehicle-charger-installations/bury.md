...
[Bury Council](https://www.mynewsdesk.com/uk/bury-council/pressreleases/green-light-for-more-ev-chargers-across-bury-3369840) has signed up to a Greater Manchester-wide scheme to install thousands of new charging points across the region, focused on locations where residents don't have driveways. That's good for public infrastructure, but home charging is still the cheapest way to run an electric car day to day.

## Working with Bury properties

Bury's housing stock covers most of what we see across North Manchester. Victorian and Edwardian terraces around the town centre and the older streets often have rear access for off-street parking where we can run cable through. Where there's no rear access, a front-mounted charger with armoured cable properly managed does the job.

The semis and larger houses spreading out towards the edges of Bury usually have driveways, which is the simplest install. Consumer units vary a lot - some of these properties have been properly updated, others still have the original installation, and that affects whether any extra electrical work is needed before the charger goes in.

The newer developments on the outskirts tend to have modern consumer units that are ready for a 7kW charger without any extra work, and most of them have off-street parking as standard.
