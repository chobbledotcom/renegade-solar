---
permalink: /saddleworth/electric-vehicle-charger-installations/
redirect_from:
  - /services/electric-vehicle-charger-installations/saddleworth/
...
We're an [Octopus Energy Trusted Partner](/accreditations/octopus-trusted-partner/) and fit their smart charger range, plus **SolaX** and **AlphaESS** units that integrate directly with solar and battery systems. The smart chargers automatically wait for the cheapest overnight window before charging.

## Installation

Done in a day (even with two charge points in most cases). Full NAPIT electrical certification. Consumer unit upgrade included in the quote if needed.
