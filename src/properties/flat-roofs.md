...
Renegade Solar is run by Ashley Merritt, an [MCS-certified](/accreditations/mcs-certified/) installer and [NAPIT registered](/accreditations/napit/) electrician based in Prestwich. On a flat roof job, the useful bit is that the person looking at the roof is also thinking about the inverter, consumer unit, cable route and any [battery storage](/services/home-battery-installations/) at the same time. It is one design, not a roofing quote with the electrical side bolted on afterwards.
...
Some flat roofs are not suitable. If the covering is near the end of its life, the structure is too light, access is poor, or nearby buildings and trees shade the roof heavily, Ashley will say so. Sometimes the better answer is a pitched-roof array, a [ground-mounted solar installation](/ground-mounted-solar-installations-manchester/), or a [home battery](/services/home-battery-installations/) without panels if solar is not worth forcing.

## Commercial flat roofs

For larger warehouses, factories, hotels and retail units, see the dedicated [flat roof commercial solar page](/flat-roof-commercial-solar-manchester/). The design principles are similar, but the financial case is different because many of those buildings use electricity during the day, when the panels are generating.

## Credentials

- [MCS-certified](/accreditations/mcs-certified/) installer (NAP-66870), so eligible systems can qualify for Smart Export Guarantee payments
